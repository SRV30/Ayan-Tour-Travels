...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white py-12 sm:py-16 px-4 sm:px-6 lg:px-16">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                ...
                <span>support@Ayan Tour & Traveles.com</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-800 text-center text-gray-500 text-sm sm:text-base">
          <p>© 2025 Ayan Tour & Traveles Platform. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
