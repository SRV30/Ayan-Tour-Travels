...
const WhatsAppFloatingButton = () => {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full p-5 shadow-xl group focus:outline-none sm:p-4 sm:bottom-5 sm:right-5"
      title="Chat on WhatsApp"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="w-7 h-7 sm:w-6 sm:h-6 fill-white group-hover:rotate-6 transition-transform duration-300"
        viewBox="0 0 32 32"
      >
      ...
      <motion.span
        ...
        className="absolute bottom-full right-1/2 translate-x-1/2 mb-2 text-xs sm:text-sm text-green-800 bg-white px-3 py-1 rounded-full shadow opacity-0 group-hover:opacity-100 transition-opacity duration-300"
      >
        Chat with us
      </motion.span>
    </motion.a>
